<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="Lab2.Main" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style14">
                    <asp:DropDownList ID="ddlOd" runat="server" OnSelectedIndexChanged="ddlOd_SelectedIndexChanged" AutoPostBack="True">
                        ...
                        <asp:ListItem>Тирана</asp:ListItem>
                        <asp:ListItem>Атина</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="auto-style20 strict-right">До</td>
            ...
            <tr>
                ...
                <td class="auto-style13">
                    <asp:DropDownList ID="ddlDen" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDen_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:DropDownList ID="ddlMesec" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDen_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:DropDownList ID="ddlGodina" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDen_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
