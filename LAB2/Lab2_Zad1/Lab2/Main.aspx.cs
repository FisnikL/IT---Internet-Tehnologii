       ...
       private static readonly string[] Months = new[]
       {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                for (int i = 0; i < 24; ++i)
                {
                    DateTime d = new DateTime(2019, 04, 07, i, 0, 0);
        ...
        protected void btnPodnesi_Click(object sender, EventArgs e)
        {
                ...
                rblZona.SelectedIndex != -1 && rblKlasa.SelectedIndex != -1 && lstSredstvo.SelectedIndex != -1)
            {
                ...
                lblVreme.Text =  ddlDen.SelectedItem.Text + "." + (ddlMesec.SelectedIndex + 1) + "." + 
                    ddlGodina.SelectedItem.Text + " во " + ddlVreme.SelectedItem.Text + " часот";
        ...
        {
            lblVreme.Text = lblVreme.Text = ddlDen.SelectedItem.Text + "." + (ddlMesec.SelectedIndex + 1) + "." +
                    ddlGodina.SelectedItem.Text + " во " + ddlVreme.SelectedItem.Text + " часот";
        }
