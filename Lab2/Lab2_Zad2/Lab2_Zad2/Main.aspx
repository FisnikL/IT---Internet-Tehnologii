<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="Lab2_Zad2.Main" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Lab2_Zad2</title>
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                            ...
                            <asp:RegularExpressionValidator ID="validatorFormatID" runat="server" ControlToValidate="txtID" Display="None" ErrorMessage="Неправилен формат на ID" ValidationExpression="[A-Z]+\d+(_\d{2,})?"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
